...
// var Viewer = module.exports = function(stlstring, element) {
...
Viewer.prototype.setCameraPosition = function(x, y, z) {
    this.camera.position.set(x, y, z);
}

Viewer.prototype.setStl = function(stlstring) {
...
Viewer.prototype.init = function(element) {
    ...
    console.log(this.container.clientWidth + " x " + this.container.clientHeight)

    // Camera
    this.camera = new THREE.PerspectiveCamera(35, this.container.clientWidth / height, 0.1, 100);
