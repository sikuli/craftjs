...
Viewer.prototype = {
    ...
    initScene: function() {
        ...
        var grid;
        //x - yz
        grid = new THREE.GridHelper(1, 0.05);
    ...
    render: function() {
        ...
        for(var i = 0; i < grids.length; i++)
        {
            ...
            var alpha = Math.cos(Math.acos(grids[i][0]*dir[0] + grids[i][1]*dir[1] + grids[i][2]*dir[2]));

            //
            //assign alpha - not done
            //this.scene.children[i+1].material = new THREE.MeshBasicMaterial({transparent:true});
            this.scene.children[i+1].material.opacity = Math.abs(alpha);
