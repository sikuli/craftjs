...
Viewer.prototype = {
    ...
    initScene: function() {
        ...
        //Grid
        var centerGrid = new THREE.GridHelper( 1, 1 );
        centerGrid.setColors(0xff0000,0xaaaaaa);
        centerGrid.rotation.x = Math.PI/2;
        this.scene.add( centerGrid );

        var majorGrid = new THREE.GridHelper(0.5, 0.05);
        majorGrid.rotation.x = Math.PI/2;
        majorGrid.position.set(-0.5,-0.5,0);
        this.scene.add(majorGrid);
        majorGrid.position.set(0, 1, 0);
        this.scene.add(majorGrid);
        majorGrid.position.set( 1,-1,0);
        this.scene.add(majorGrid);
        majorGrid.position.set( 0, 1,0);
        this.scene.add(majorGrid);
